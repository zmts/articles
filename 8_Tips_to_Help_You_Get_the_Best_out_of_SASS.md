...
Такая структура позволяет с легкостью обходится с нашим сайтом. Например для добавления нового модуля, необходимо создать новый фрагмент в папке __base__ и импортировать его в global.scss с помощью  директиы __@import__.
